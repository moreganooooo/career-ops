...
user-invocable: true
argument-hint: "[scan | deep | pdf | coverletter | offer | offers | apply | batch | tracker | pipeline | contact | training | project | interview-prep | update]"
license: MIT
---
...
Applies to: `auto-pipeline`, `offer`, `offers`, `pdf`, `coverletter`, `contact`, `apply`, `pipeline`, `scan`, `batch`
